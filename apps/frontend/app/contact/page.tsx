            ...
            {contactMethods.map((method, index) => (
              ...
              >
                <div className="text-center mb-6">
                  <div
                    className={`inline-flex items-center justify-center w-12 h-12 rounded-xl border ${method.color} mb-4`}
                  >
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-6 sm:p-8 text-center">
            ...
            <div className="border-t border-slate-700 pt-6 mt-6">
              <p className="text-sm text-slate-400">
                Response times are during business hours (Mon-Fri 8AM-6PM EST). Urgent support
                issues are handled 24/7 for enterprise customers.
              </p>
            </div>
          </div>
        </div>

    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button className="pill pill-ghost sm" onClick={() => router.back()}>
            Cancel
          </button>
        </div>
        ...
        <form onSubmit={submit} className="surface-solid p-6 space-y-4">
          ...
          <div className="flex items-center justify-end gap-3">
            <button type="button" className="pill pill-ghost" onClick={() => router.back()}>
              Cancel
            </button>
            <button type="submit" className="pill pill-tint-green">
              Save
            </button>
          </div>
        </form>

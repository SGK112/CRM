        ...
        <div className="flex bg-white dark:bg-gray-800 rounded-lg border border-gray-300 dark:border-gray-600 p-1">
          {[
            ...
            <button
              key={viewOption.key}
              onClick={() =>
                setView(viewOption.key as 'dayGridMonth' | 'timeGridWeek' | 'timeGridDay')
              }
      ...
      <div className={simple.card('mt-6')}>
        <div className={simple.section()}>
          ...
          <div className="space-y-3">
            {filteredAppointments
              ...
              .map(appointment => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-3 h-3 rounded-full bg-${getEventColor(appointment.status).substring(1)}`}
                    ></div>
                    <div>
            ...
            {filteredAppointments.filter(apt => new Date(apt.startDateTime) > new Date()).length ===
              0 && (

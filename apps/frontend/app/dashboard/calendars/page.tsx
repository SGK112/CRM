...
export default function CalendarsPage() {
      ...
      const mockEvents: CalendarEvent[] = [
        {
          ...
          description:
            'Initial kitchen renovation consultation and measurements. Discuss layout options, material preferences, and budget.',
    ...
    try {
      ...
      setIntegrations(prev =>
        prev.map(integration =>
          integration.isConnected ? { ...integration, lastSync: new Date() } : integration
        )
      );
  ...
  const upcomingEvents = useMemo(() => {
    ...
    return filteredEvents
      .filter(
        event => event.start >= now && event.start <= next7Days && event.status !== 'cancelled'
      )
      ...
      <StandardPageWrapper>
        <div className="space-y-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold theme-text">Calendar</h1>
              <p className="theme-text-muted mt-2">Loading events...</p>
            </div>
          </div>
          <StandardGrid cols={4}>
            {Array.from({ length: 4 }).map((_, i) => (
              <StandardCard key={i} className="animate-pulse">
                <div className="space-y-4">
                  <div className="h-4 theme-surface-3 rounded w-3/4"></div>
                  <div className="h-8 theme-surface-3 rounded w-1/2"></div>
                </div>
              </StandardCard>
            ))}
          </StandardGrid>
    ...
    return (
      <StandardPageWrapper>
        <StandardCard className="text-center py-12">
          ...
          <StandardButton onClick={() => fetchEvents()}>Try Again</StandardButton>
        </StandardCard>
      </StandardPageWrapper>
    );
  }
    ...
    <StandardPageWrapper>
      <div className="space-y-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div>
            <h1 className="text-3xl font-bold theme-text">Unified Calendar</h1>
            <p className="theme-text-muted mt-2">
              Professional calendar management with multi-platform integration and advanced
              scheduling.
            </p>
          </div>
          <div className="flex items-center gap-3">
            ...
            >
              Filters
              {[typeFilter, statusFilter, priorityFilter, clientFilter, sourceFilter].filter(
                f => f !== 'all'
              ).length > 0 && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full p-2.5 border theme-border rounded-lg theme-surface-1 theme-text focus:ring-2 focus:ring-red-500 focus:border-red-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 border theme-border rounded-lg theme-surface-1 theme-text placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-red-500 focus:border-red-500"
                />
              </div>
            </div>
            ...
            <StandardCard>
              ...
              <div className="flex items-center justify-between p-6 border-b theme-border">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-1 theme-surface-2 rounded-lg p-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <StandardButton variant="secondary" size="sm" onClick={() => window.print()}>
                    Export
                  </StandardButton>
                </div>
              </div>
              ...
              <div className="p-6">
                {calendarView === 'calendar' ? (
                  <div style={{ height: '700px' }} className="theme-surface-1 rounded-lg">
                    <Calendar
                      localizer={localizer}
                          ...
                          <div className="p-1 h-full">
                            <div className="flex items-center gap-1 mb-1">
                              <span className="text-xs">
                                {
                                  priorityIndicators[
                                    event.priority as keyof typeof priorityIndicators
                                  ]
                                }
                              </span>
                    ...
                    {filteredEvents.length > 0 ? (
                      filteredEvents.map(event => (
                        <div
                          ...
                          className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border theme-border hover:shadow-md hover:border-red-300 dark:hover:border-red-600 transition-all duration-200 cursor-pointer"
                        >
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-2">
                                <span>{priorityIndicators[event.priority]}</span>
                                <h3 className="font-semibold theme-text">{event.title}</h3>
                                <span
                                    ...
                                    event.status === 'confirmed'
                                      ...
                                      : event.status === 'scheduled'
                                        ...
                                        : event.status === 'completed'
                                          ? 'theme-surface-2 theme-text-muted'
                              ...
                              <div className="flex items-center gap-4 text-sm theme-text-muted mb-2">
                            ...
                            <div className="flex items-center gap-2 ml-4">
                              ...
                              <div className="text-xs theme-text-muted capitalize theme-surface-2 px-2 py-1 rounded">
                      ...
                      <div className="text-center py-12">
                        ...
                        <p className="theme-text-muted">No events found matching your filters</p>
                      </div>
                    )}
                  </div>
                )}
            ...
            <StandardCard>
              ...
              {todaysEvents.length > 0 ? (
                <div className="space-y-3">
                  {todaysEvents.map(event => (
                    <div
                      key={event.id}
                      onClick={() => handleSelectEvent(event)}
                      className="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200 border theme-border"
                    >
                ...
                <div className="text-center py-4">
                  ...
                  <p className="text-sm theme-text-muted">No events scheduled for today</p>
                </div>
              )}
            </StandardCard>
            ...
            <StandardCard>
              ...
              {upcomingEvents.length > 0 ? (
                ...
                <div className="text-center py-4">
                  ...
                  <p className="text-sm theme-text-muted">No upcoming events</p>
                </div>
              )}
            </StandardCard>
            ...
            <StandardCard>
              ...
              <div className="space-y-3">
                {integrations.map(integration => (
                  <div
                    key={integration.id}
                    className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border theme-border"
                  >
                    <div className="flex items-center gap-3">
                      <div
            ...
            <StandardCard>
              ...
              <div className="space-y-2">
                ...
                <StandardButton
                  ...
                  onClick={handleSyncCalendars}
                  disabled={syncing}
                  icon={<ArrowPathIcon className={`w-4 h-4 ${syncing ? 'animate-spin' : ''}`} />}
                >
                  Sync Calendars
                </StandardButton>
        ...
        {showEventModal && selectedEvent && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="theme-surface-1 rounded-xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto border theme-border">
              <div className="sticky top-0 theme-surface-1 border-b theme-border px-6 py-4 rounded-t-xl">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <span>{priorityIndicators[selectedEvent.priority]}</span>
                    <h2 className="text-xl font-bold theme-text">{selectedEvent.title}</h2>
                    <span
              ...
              <div className="px-6 py-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {selectedEvent.clientName && (
                    <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <div>
                        <div className="text-sm font-medium theme-text">Client</div>
                        <div className="text-sm text-gray-600 dark:text-gray-300">
                          {selectedEvent.clientName}
                        </div>
                      </div>
                  ...
                  {selectedEvent.location && (
                    <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg md:col-span-2">
                      ...
                      <div>
                        <div className="text-sm font-medium theme-text">Location</div>
                        <div className="text-sm text-gray-600 dark:text-gray-300">
                          {selectedEvent.location}
                        </div>
                      </div>
                ...
                {selectedEvent.description && (
                  <div>
                    <h4 className="font-medium theme-text mb-2">Description</h4>
                ...
                <div className="flex flex-col sm:flex-row justify-between gap-4 pt-4 border-t theme-border">
                  ...
                  <div className="flex gap-2">
                    <StandardButton
                      size="sm"
                      as={Link}
                      href={`/dashboard/calendars/${selectedEvent.id}/edit`}

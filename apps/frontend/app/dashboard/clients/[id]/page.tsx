...
export default function ClientDetailPage() {
  ...
  const tabs = [
    ...
    { id: 'projects', name: 'Projects', icon: ClipboardDocumentListIcon, activeIcon: ClipboardIconSolid },
    ...
    { id: 'communications', name: 'Communications', icon: ChatBubbleLeftRightIcon, activeIcon: ChatIconSolid },
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <dd className="mt-1 text-sm text-gray-900">{client.projectType || 'Not specified'}</dd>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <dd className="mt-1 text-sm text-gray-900">{client.source || 'Not specified'}</dd>
                  </div>
                  <div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium text-gray-900">
                      {communications.length > 0 ? formatDate(communications[0].timestamp) : 'Never'}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="grid gap-4">
              ...
              {appointments.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="mt-1 text-sm text-gray-500">Schedule your first appointment with this client.</p>
                </div>
              )}
            </div>
          </div>
                          ...
                          <div className="relative flex space-x-3">
                            <div>
                              <span className={`h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white ${
                                ...
                                comm.type === 'call' ? 'bg-purple-500' : 'bg-gray-500'
                              }`}>
                                {comm.type === 'email' ? (
                            ...
                            <div className="min-w-0 flex-1 pt-1.5">
                              ...
                              <div className="mt-2">
                                ...
                                {comm.status && (
                                  <span className={`mt-2 inline-flex px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(comm.status)}`}>
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-blue-500 pl-4">
                    ...
                    <p className="text-sm text-gray-600 mt-2">
                      Client confirmed interest in kitchen renovation. Scheduling site visit for next week.
                    </p>
                  </div>

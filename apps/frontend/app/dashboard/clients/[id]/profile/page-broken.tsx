...
export default function ContactProfilePage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      {/* Main Content - Single Large Profile Card with Embedded Chat */}
      <div className="p-4 sm:p-6">
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden">
          ...
          {/* Profile Content with Embedded Chat */}
          <div className="p-4 sm:p-6">
            ...
            {/* Embedded Chat UI Section */}
            <div className="mt-6 border border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-slate-700/30 overflow-hidden">
              {/* Chat Header */}
              ...
              {/* Chat Messages */}
              <div className="h-80 p-4 overflow-y-auto bg-white dark:bg-slate-800">
                {messages.length === 0 ? (

  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <div className="flex min-h-screen">
        {/* Main Content - Single Large Tool Card */}
        <div className="flex-1 p-4 sm:p-6 pr-80"> {/* Add right padding for floating chat */}
        ...
        {/* Floating Chat UI */}
        <div className="fixed right-4 top-20 bottom-4 w-72 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 flex flex-col">
          {/* Chat Header */}
          <div className="p-4 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-t-xl">
            <div className="flex items-center gap-3">
              <ChatBubbleLeftRightIcon className="h-5 w-5" />
              <div>
                <h3 className="font-medium">Chat with {contact.firstName}</h3>
                <p className="text-xs text-blue-100">Click to start conversation</p>
              </div>
            </div>
          </div>
          
          {/* Chat Content */}
          <div className="flex-1 p-4 flex items-center justify-center text-slate-500 dark:text-slate-400">

    ...
    <div className={simple.page()}>
      ...
      <div className={`${simple.card()} mb-6`}>
        <div className={simple.section()}>
          <h1 className={simple.text.title('mb-2')}>{getGreeting()}</h1>
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span
                      className={`inline-flex px-2 py-1 rounded-full text-xs font-medium capitalize ${getStatusColor(project.status)}`}
                    >
                      {project.status}
                    </span>
                  </div>

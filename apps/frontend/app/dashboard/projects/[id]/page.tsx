...
interface Client {
  ...
  phone?: string;
  company?: string;
  name?: string; // Computed name property
}
              ...
              {client && (
                <div className="flex items-center mb-2 text-blue-100">
                  ...
                  <Link
                    ...
                    className="text-white hover:text-blue-200 font-medium ml-1 flex items-center underline decoration-1 underline-offset-2"
                  >
                ...
                {client && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <Link
                        href={`/dashboard/clients/${client._id}`}
                        className="font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center"
                      >
                        {client.name || `${client.firstName} ${client.lastName}`}
                        <FiExternalLink className="ml-1 w-3 h-3" />
                      </Link>

...
export default function NewDashboardProjectPage() {
  ...
  useEffect(() => {
    if (clients.length > 0 && searchParams) {
      ...
      if (clientId) {
        // Always set clientId from URL, even if already set
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="flex-1">
          ...
          {(selectedClient || preselectedClientId) && (
            <nav className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400 mb-2">
              <Link href="/dashboard/clients" className="hover:text-gray-700 dark:hover:text-gray-200">
                Clients
              </Link>
              <span>•</span>
              <Link
      ...
      {/* Client Info Header */}
      {(selectedClient || (preselectedClientId && clients.length > 0) || (preselectedClientId && clientsLoading)) && (
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
          <div className="flex items-center justify-between">
            <div>
              {clientsLoading && preselectedClientId ? (
                <div className="animate-pulse">
                  <div className="h-5 bg-blue-200 dark:bg-blue-700 rounded w-48 mb-2"></div>
                  <div className="h-4 bg-blue-100 dark:bg-blue-800 rounded w-32"></div>
                </div>
              ) : selectedClient ? (
                <>
                ...
                <div className="text-blue-900 dark:text-blue-100">
                  <h3 className="font-medium">Loading client information...</h3>
                  <div className="text-sm text-blue-700 dark:text-blue-300 mt-1">
            ...
            {(selectedClient || preselectedClientId) && !clientsLoading && (

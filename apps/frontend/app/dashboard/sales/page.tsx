        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div>
            ...
            <p className="theme-text-muted mt-2">
              Manage estimates, invoices, and track payment performance across all client
              interactions.
            </p>
          </div>
              ...
              <StandardCard>
                ...
                <div className="space-y-4">
                  {estimates.slice(0, 3).map(estimate => (
                    <div
                      key={estimate.id}
                      className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border theme-border hover:shadow-md transition-shadow"
                    >
              ...
              {estimates.map(estimate => (
                <StandardCard key={estimate.id} hover className="group">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <p className="text-2xl font-bold theme-text mb-2">

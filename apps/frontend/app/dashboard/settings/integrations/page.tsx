...
export default function IntegrationsSettingsPage() {
  ...
  // Use relative API base; Next.js rewrites proxy to the backend in all envs
  const API_BASE = '/api';
  ...
  const handleConnect = () => {
    // Use relative OAuth path; rewritten to backend via next.config.js
          ...
          <div className="p-4 sm:p-6 pt-0">
            {loading ? (
              ...
              <div className="space-y-3">
                ...
                <div className={simple.text.body()}>
            ...
            <div className="p-4 sm:p-6 pt-0">
              {events.length === 0 ? (
                <div className={simple.empty.container}>
                  ...
                  <div className={simple.empty.description}>
                    Click "Refresh Upcoming Events" to load.
                  </div>
                </div>
              ) : (
                  ...
                  {events.map(e => (
                    <li key={e.id} className="py-2">
                      ...
                      <div className={simple.text.small()}>
                        ...
                        {(e.end?.dateTime || e.end?.date || '').toString()}
                      </div>
                    </li>
                  ))}
                </ul>

...
const testimonials = [
  {
    ...
    content:
      'Testing Remodely CRM for our Phoenix projects. The mobile-first approach is exactly what we need for Arizona job sites.',
    rating: 5,
  ...
  },
  {
    ...
    content:
      'Being part of the beta program has been great. The app works perfectly for our Scottsdale kitchen remodeling projects.',
    rating: 5,
  ...
  },
  {
    ...
    content:
      "As a beta tester, I love how Remodely CRM handles our pool construction workflow. Perfect for Arizona's outdoor living market.",
    rating: 5,
        ...
        <section className="relative z-10 px-4 py-12 sm:py-20 lg:py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-[var(--text-dim)] mb-6 sm:mb-8 leading-relaxed">
              Arizona's premier construction CRM. Manage projects, estimates, and client
              communication from Phoenix to Tucson and everywhere in between.
            </p>
            ...
            <div className="flex flex-col items-center justify-center gap-4 mb-8 sm:mb-12 max-w-md mx-auto">
              <Link
                href="/auth/register"
                className="btn btn-amber shadow-glow professional-shine text-base sm:text-lg px-8 py-4 w-full text-center"
              >
                Start Free Trial
              </Link>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full">
                <Link
                  href="/contact"
                  className="btn btn-outline text-base px-6 py-3 hover:border-amber-500/60 hover:text-amber-300 transition flex items-center justify-center"
                >
            ...
            {/* Enhanced Mobile app preview mockup */}
                ...
                <div className="bg-[var(--bg)] rounded-2xl overflow-hidden shadow-inner">
                  ...
                  <div className="p-4 space-y-4 bg-gradient-to-b from-[var(--surface-1)] to-[var(--bg)]">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-amber-600 font-medium text-sm bg-amber-50 dark:bg-amber-900/20 px-2 py-1 rounded-full">
                        3 active
                      </span>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-white dark:bg-[var(--surface-2)] rounded-xl p-4 border border-[var(--border)] shadow-soft card-hover">
                        <div className="flex justify-between items-start mb-3">
                          ...
                          <span className="text-xs text-amber-600 bg-amber-50 dark:bg-amber-900/30 px-2 py-1 rounded-full font-medium">
                            Estimate Sent
                          </span>
                        </div>
                        <p className="text-xs text-[var(--text-dim)]">
                          Waiting for approval • $24,500
                        </p>
                      </div>
                    </div>
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-6 sm:mb-8">
              ...
              <p className="text-sm text-[var(--text-dim)]">
                Development stage - launching across Arizona first
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-12 max-w-4xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-sm sm:text-base text-[var(--text-dim)]">
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                <span className="gradient-amber">Run, Grow & Automate</span> Your Arizona
                Construction Business
              </h2>
              <p className="text-xl text-[var(--text-dim)] max-w-3xl mx-auto">
                Three core pillars designed specifically for Arizona's construction market and
                climate.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
              {businessPillars.map((pillar, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`text-center p-8 lg:p-10 rounded-2xl bg-gradient-to-br ${colors.gradient} border border-[var(--border)] hover:shadow-lg transition-all duration-300 hover:scale-105`}
                  >
                    <div
                      className={`inline-flex items-center justify-center w-16 h-16 lg:w-20 lg:h-20 rounded-2xl mb-6 ${colors.bg} ring-1 ${colors.ring}`}
                    >
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
              {coreFeatures.map((feature, index) => (
                <div
                  key={index}
                  className="p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-[var(--bg)] to-[var(--surface-2)] border border-[var(--border)] hover:border-amber-500/50 transition-all duration-300 hover:shadow-lg hover:scale-105 group"
                >
                  ...
                  <p className="text-[var(--text-dim)] text-sm sm:text-base leading-relaxed">
                    {feature.description}
                  </p>
                </div>
              ))}
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 sm:gap-6">
              {[
                ...
                <div
                  key={index}
                  className={`${trade.color} rounded-2xl p-4 sm:p-6 border text-center hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer group`}
                >
                  <div className="text-2xl sm:text-3xl mb-2 sm:mb-3 transition-transform group-hover:scale-110">
                    {trade.icon}
                  </div>
                ...
                <div className="grid lg:grid-cols-3 gap-6 lg:gap-8 items-center">
                  ...
                  <div className="lg:col-span-2">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-[var(--text-dim)] text-xs uppercase tracking-wide">
                  ...
                  <div className="bg-gradient-to-br from-[var(--surface-2)] to-[var(--surface-1)] rounded-xl p-6 border border-[var(--border)]">
                    <div className="space-y-4">
                      {Object.entries(testimonials[activeTestimonial].metrics).map(
                        ([key, value], index) => (
                  ...
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${
                      index === activeTestimonial
                        ...
                        : 'bg-[var(--border)] hover:bg-amber-600/50'
                    }`}
                  />
                ))}
              </div>
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="bg-gradient-to-r from-amber-600/10 to-amber-500/5 rounded-2xl sm:rounded-3xl p-8 sm:p-12 border border-amber-500/20 text-center">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6">
                ...
                <span className="gradient-amber">Arizona Construction Business?</span>
              </h2>
              <p className="text-lg sm:text-xl text-[var(--text-dim)] mb-6 sm:mb-8 max-w-2xl mx-auto">
                Join our exclusive beta program for Arizona contractors and help shape the future of
                construction CRM.
              </p>
              ...
              <div className="flex flex-col items-center gap-4 mb-6 sm:mb-8 max-w-md mx-auto">
                ...
                <Link
                  href="/contact"
                  className="btn btn-outline text-base px-8 py-3 hover:border-amber-500/60 hover:text-amber-300 transition w-full text-center"
                >
                  <UserGroupIcon className="mr-2 h-4 w-4" />
                  Schedule a Demo
                </Link>

      ...
      <section className="px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto">
            See what we're building to make construction project management even more powerful and
            intuitive.
          </p>
        </div>
      </section>
          ...
          <div className="mt-12 text-center">
            <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-6 sm:p-8">
              ...
              <p className="text-slate-400 mb-6 text-sm sm:text-base">
                We love hearing from our users. Share your ideas and help shape the future of
                Remodely CRM.
              </p>

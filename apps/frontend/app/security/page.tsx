...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Remodely CRM's security practices, data protection, and compliance standards.",
};
...
const dataHandling = [
  {
    ...
    description:
      'We only collect data necessary for providing our CRM services and improving user experience.',
  },
  {
    title: 'Data Storage',
    description:
      'All data is stored in secure, enterprise-grade cloud infrastructure with geographic redundancy.',
  },
  {
    title: 'Data Processing',
    description:
      'Data processing is performed only for legitimate business purposes with appropriate safeguards.',
  },
  {
    title: 'Data Retention',
    description:
      'We retain data only as long as necessary for business purposes or as required by law.',
  },
  {
    title: 'Data Deletion',
    description:
      'Customers can request data deletion at any time, and we provide secure data destruction.',
  },
  {
    title: 'Data Portability',
    description:
      'Export your data in standard formats whenever you need it, maintaining full data ownership.',
  },
];
      ...
      <section className="px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Your business data deserves enterprise-grade protection. Learn how we keep your
            information secure with industry-leading security practices and compliance standards.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {certifications.map((cert, index) => (
              <div
                key={index}
                className="rounded-lg border border-slate-800 bg-slate-900/40 p-6 sm:p-8"
              >
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-400 text-sm sm:text-base">
              Our comprehensive incident response plan ensures rapid detection, containment, and
              resolution.
            </p>
          </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-slate-400">
                  <li className="flex items-center gap-2">
                    ...
                    <a href="/docs/security" className="hover:text-emerald-400 transition-colors">
                      Security Best Practices Guide
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 bg-emerald-400 rounded-full" />
                    <a href="/docs/privacy" className="hover:text-emerald-400 transition-colors">
                      Privacy Policy
                    </a>
                  </li>
                  <li className="flex items-center gap-2">

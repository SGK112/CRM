...
const faqs = [
  {
    ...
    answer:
      'You can import client data using our CSV import tool. Go to Clients > Import and download our template. Make sure your data matches the required format.',
  },
  {
    question: 'Can I use Remodely CRM on mobile devices?',
    answer:
      'Yes! Remodely CRM is fully responsive and works great on mobile browsers. We also have native mobile apps coming in Q2 2025.',
  },
  {
    question: 'How do I add team members to my account?',
    answer:
      'Go to Settings > Team and click "Invite Member". You can set different permission levels for each team member based on their role.',
  },
  {
    question: 'What integrations are available?',
    answer:
      'We integrate with popular tools like QuickBooks, Google Calendar, Slack, and more. Check our integrations page for the full list.',
  },
  {
    question: 'Is my data secure?',
    answer:
      'Absolutely. We use enterprise-grade security with encryption at rest and in transit, regular backups, and SOC 2 compliance.',
  },
  {
    question: 'Can I cancel my subscription anytime?',
    answer:
      'Yes, you can cancel your subscription at any time from your billing settings. Your data will remain accessible for 30 days after cancellation.',
  },
];
      ...
      <section className="px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto">
            We're here to help you get the most out of Remodely CRM. Choose the support option that
            works best for you.
          </p>
        </div>
      </section>
            ...
            {supportOptions.map((option, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-lg border ${option.color}`}
                  >

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {keyFeatures.map((feature, index) => (
            <div
              key={index}
              className="bg-slate-900/60 rounded-lg p-6 border border-slate-800 hover:border-amber-500/40 transition"
            >
                ...
                <div className="ml-4">
                  ...
                  <ul className="space-y-2">
                    {feature.benefits.map((benefit, benefitIndex) => (
                      <li
                        key={benefitIndex}
                        className="flex items-center text-sm text-slate-300 bg-slate-800/60 rounded-md px-3 py-2 border border-slate-700"
                      >

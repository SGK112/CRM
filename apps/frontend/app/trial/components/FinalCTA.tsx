      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-slate-400 mb-8 max-w-3xl mx-auto">
            Join 5,000+ construction professionals who've increased efficiency by 45% with Remodely
            CRM
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Link
              href="/auth/register"
              className="bg-amber-600 hover:bg-amber-500 px-8 py-4 rounded-lg text-lg font-semibold inline-flex items-center justify-center transition-all transform hover:scale-105 shadow shadow-amber-600/30"
            >
            ...
            <Link
              href="/demo"
              className="border border-slate-600 hover:border-amber-500/60 text-slate-300 hover:text-amber-400 px-8 py-4 rounded-lg text-lg font-semibold inline-flex items-center justify-center transition-colors"
            >
          ...
          <div className="mt-12 border-t border-slate-800 pt-8">
            <p className="text-slate-500 text-sm mb-4">
              Trusted by construction companies nationwide
            </p>

...
const integrations = [
  {
    ...
    description: 'Sync finances automatically',
  },
  {
    ...
    <div className="bg-slate-900/60 py-16 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-400">Connect with the tools you already use and love</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {integrations.map((integration, index) => (
            <div
              key={index}
              className="bg-slate-900/60 rounded-lg p-4 text-center shadow-sm hover:shadow-lg hover:shadow-amber-600/10 border border-slate-800 hover:border-amber-500/40 transition"
            >
              <img
              ...
              />
              <h4 className="text-sm font-medium text-slate-200 mb-1">{integration.name}</h4>

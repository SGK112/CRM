...
import { BuildingOfficeIcon, UserGroupIcon, MapPinIcon, ClockIcon } from '@heroicons/react/24/outline'

export const metadata: Metadata = {
  title: 'About Us | Remodely CRM',
  description: 'Learn about Remodely CRM - our mission, team, and commitment to helping contractors grow their business.'
}

const values = [
  {
    title: 'Customer Success',
    description: 'Your success is our success. We build features that help contractors win more projects and grow their business.',
    icon: UserGroupIcon
  },
  {
    title: 'Simplicity',
    description: 'Complex problems deserve simple solutions. We make powerful tools that are easy to use and understand.',
    icon: BuildingOfficeIcon
  },
  {
    title: 'Reliability',
    description: 'Contractors depend on us to run their business. We maintain 99.9% uptime and enterprise-grade security.',
    icon: ClockIcon
  },
  {
    title: 'Innovation',
    description: 'The construction industry is evolving. We stay ahead with cutting-edge technology and modern workflows.',
    icon: MapPinIcon
  }
]
...
const timeline = [
  {
    ...
    description: 'Sarah and Mike started Remodely after experiencing firsthand the challenges of managing a contracting business with outdated tools.'
  },
  {
    year: '2022',
    title: 'Beta Launch',
    description: 'Launched with 50 beta contractors to validate our approach and gather feedback on core features.'
  },
  {
    year: '2023',
    title: 'Series A Funding',
    description: 'Raised $5M Series A to accelerate product development and grow our team of industry experts.'
  },
  {
    year: '2024',
    title: 'Mobile App Launch',
    description: 'Released native mobile apps to help contractors manage their business from anywhere, anytime.'
  }
]
      ...
      <section className="px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            We're building the future of contractor business management. Our mission is to help contractors 
            focus on what they do best while we handle the business side.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {stats.map((stat, index) => (
              <div key={index} className="text-center p-4 sm:p-6 rounded-xl border border-slate-800 bg-slate-900/40">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-slate-300 leading-relaxed">
                <p className="text-sm sm:text-base">
                  Remodely was born from frustration. Our founder Sarah spent years running a successful 
                  remodeling business, but was constantly battling with outdated software that made simple 
                  tasks complicated and expensive.
                </p>
                <p className="text-sm sm:text-base">
                  After trying every CRM on the market and finding them all lacking, Sarah teamed up with 
                  Mike, a seasoned software architect, to build something better. Something designed 
                  specifically for contractors, by contractors.
                </p>
                <p className="text-sm sm:text-base">
            ...
            <div className="rounded-xl bg-slate-900/40 border border-slate-800 p-6 sm:p-8">
              <blockquote className="text-lg sm:text-xl text-slate-200 font-medium mb-4">
                "We built Remodely to be the CRM we always wished we had when we were running our own contracting business."
              </blockquote>
            ...
            {team.map((member, index) => (
              <div key={index} className="rounded-xl border border-slate-800 bg-slate-900/40 p-6 sm:p-8">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-semibold text-slate-200">{member.name}</h3>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-6 sm:p-8 text-center">
            ...
            <p className="text-slate-400 mb-6 text-sm sm:text-base">
              Whether you're a contractor looking for better tools or a talented professional wanting to join our team, we'd love to hear from you.
            </p>

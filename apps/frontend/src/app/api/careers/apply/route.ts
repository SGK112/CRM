...
export async function POST(request: NextRequest) {
  try {
    ...
    const requiredFields = ['firstName', 'lastName', 'email', 'phone', 'location', 'experience', 'coverLetter', 'motivation', 'availability', 'jobTitle']
...
async function sendApplicationEmails(applicationData: any, resumeFile: File, portfolioFiles: File[]) {

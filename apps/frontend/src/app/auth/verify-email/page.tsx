    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <Card className={`${getStatusColor()} border-2`}>
          <CardHeader className="text-center pb-4">
            <CardTitle className="text-xl flex items-center justify-center gap-2 mb-3">
              {verificationStatus !== 'pending' && verificationStatus !== 'success' && verificationStatus !== 'error' && (
          ...
          <CardContent className="space-y-4">
            {message && (
              <div className={`p-3 rounded-md border ${verificationStatus === 'error' ? 'border-red-200 bg-red-50 text-red-800' : 'border-green-200 bg-green-50 text-green-800'}`}>
                {message}
              </div>
            )}
            ...
            {!token && (
              <div className="space-y-4">
                ...
                <Button 
                  ...
                  className="w-full"
                  iconLeft={isResending ? <Loader2 className="h-4 w-4 animate-spin" /> : <Mail className="h-4 w-4" />}
                >
        ...
        <div className="text-center text-xs text-gray-500">
          <p>Need help? <a href="/support" className="text-blue-600 hover:text-blue-500">Contact Support</a></p>
        </div>
      </div>
    </div>
  );

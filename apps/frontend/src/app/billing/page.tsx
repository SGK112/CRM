...
export default function BillingPage() {
  ...
  const getActivityColor = (type: string) => {
    switch (type) {
      case 'subscription_created': return 'text-green-600';
      case 'subscription_cancelled': return 'text-red-600';
      case 'payment_succeeded': return 'text-green-600';
          ...
          {userSubscription && (
            <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-lg font-semibold text-blue-600">{userSubscription.plan.name}</p>

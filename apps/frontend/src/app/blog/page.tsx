...
const blogPosts = [
  {
    ...
    excerpt: 'Discover how artificial intelligence is revolutionizing the way construction teams plan, execute, and deliver projects.',
    author: 'Sarah Chen',
    date: '2025-01-15',
  ...
  },
  {
    ...
    excerpt: 'Learn why mobile-first design is crucial for construction teams and how it improves productivity on job sites.',
  ...
  },
  {
    ...
    excerpt: 'Effective communication strategies that keep clients informed and projects on track throughout the construction process.',
  ...
  },
  {
    ...
    excerpt: 'How digital documentation is replacing paper processes and improving project transparency and compliance.',
    author: 'David Park',
    date: '2024-12-28',
    category: 'Technology',
    readTime: '7 min read',
  ...
  },
  {
    ...
    excerpt: 'Tips and strategies for building strong relationships with subcontractors that lead to successful project delivery.',
  ...
  },
  {
    ...
    excerpt: 'Proven methods for keeping construction projects on budget without sacrificing quality or timeline.',
    author: 'Robert Kim',
    date: '2024-12-15',
    category: 'Finance',
...
const categories = ['All', 'Industry Insights', 'Product Updates', 'Best Practices', 'Technology', 'Management', 'Finance']
      ...
      <section className="px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto">
            Industry insights, best practices, and product updates to help your construction business thrive.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {blogPosts.map((post, index) => (
              <article key={index} className="rounded-xl border border-slate-800 bg-slate-900/40 overflow-hidden hover:border-amber-500/40 transition-colors group">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-6 sm:p-8 text-center">
            ...
            <p className="text-slate-400 mb-6 text-sm sm:text-base">
              Get the latest construction industry insights and product updates delivered to your inbox.
            </p>

...
const openings = [
  {
    ...
    type: 'Full-time',
    description: 'Lead development of core CRM features using React, Node.js, and modern cloud technologies. 5+ years experience required.',
    requirements: [
  ...
  },
  {
    ...
    location: 'San Francisco, CA / Remote',
    type: 'Full-time',
    description: 'Design intuitive interfaces for contractors. Create user experiences that simplify complex business workflows.',
    requirements: [
  ...
  },
  {
    ...
    location: 'San Francisco, CA / Remote',
    type: 'Full-time',
    description: 'Build and maintain our cloud infrastructure. Ensure 99.9% uptime for mission-critical contractor workflows.',
    requirements: [
  ...
  },
  {
    ...
    type: 'Full-time',
    description: 'Help contractors succeed with Remodely. Drive adoption, reduce churn, and identify expansion opportunities.',
    requirements: [
  ...
  },
  {
    ...
    location: 'San Francisco, CA / Remote',
    type: 'Full-time',
    description: 'Drive growth through content marketing, SEO, and demand generation. Target contractor audiences across digital channels.',
    requirements: [
  ...
  },
  {
    ...
    location: 'San Francisco, CA',
    type: 'Full-time',
    description: 'Generate qualified leads and build pipeline. First point of contact for contractors interested in Remodely.',
    requirements: [
...
const values = [
  {
    ...
    description: 'We start with the contractor and work backwards. Every decision is made with our customers in mind.'
  },
  {
    title: 'Ownership',
    description: 'We take ownership of our work and outcomes. We think like owners because we are owners.'
  },
  {
    title: 'High Standards',
    description: 'We maintain exceptionally high standards and continuously raise the bar for ourselves and our products.'
  },
  {
      ...
      <section className="px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Help us build the future of contractor business management. Join a team that's passionate about 
            solving real problems for hardworking professionals.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-400 text-sm sm:text-base max-w-2xl mx-auto">
              We're building more than software—we're creating a workplace where talented people can do their best work.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6 lg:gap-8">
            {values.map((value, index) => (
              <div key={index} className="rounded-xl border border-slate-800 bg-slate-900/40 p-6 sm:p-8">
                <h3 className="text-lg sm:text-xl font-semibold mb-3 text-purple-300">{value.title}</h3>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => (
              <div key={index} className="text-center p-6 rounded-xl border border-slate-800 bg-slate-900/40">
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-400 text-sm sm:text-base">
              We're actively hiring for these roles. Don't see a perfect fit? Send us your resume anyway.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { step: '2', title: 'Phone Screen', description: '30-minute call with our recruiting team to discuss the role.' },
              { step: '3', title: 'Technical Interview', description: 'Role-specific interview with the hiring manager and team.' },
              { step: '4', title: 'Final Round', description: 'Meet with leadership and get a feel for our company culture.' }
            ].map((process, index) => (

    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-3xl font-bold text-brand-700 dark:text-brand-400 mb-2">Calendar & Appointments</h1>
            <p className="text-gray-600">Manage your appointments and schedule with calendar integrations</p>
          </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 text-sm">Export appointments to your favorite calendar app</p>
            </div>

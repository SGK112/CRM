    ...
    return (
      <StandardPageWrapper>
        <StandardCard className="text-center py-12">
          ...
          <p className="theme-text-muted mb-6">Please try again or contact support if the problem persists.</p>
          <StandardButton onClick={() => fetchEvents()}>
            Try Again
          </StandardButton>
        </StandardCard>
      </StandardPageWrapper>
                            ...
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                                  ...
                                  event.status === 'completed' ? 'theme-surface-2 theme-text-muted' :
                  ...
                  {selectedEvent.clientName && (
                    <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-300">{selectedEvent.clientName}</div>
                      </div>
                    </div>
                  )}
                  ...
                  {selectedEvent.location && (
                    <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg md:col-span-2">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-300">{selectedEvent.location}</div>
                      </div>
                    </div>
                  )}
                </div>

...
interface Notification {
  id: string;
  type: 'payment' | 'conversation' | 'project_update' | 'calendar' | 'estimate' | 'invoice' | 'system' | 'client_action';
  title: string;
  description: string;
  timestamp: Date;
  isRead: boolean;
...
export default function CommunicationsPage() {
  const [activeTab, setActiveTab] = useState<'all' | 'notifications' | 'messages' | 'payments'>('all');
      ...
      const mockNotifications: Notification[] = [
        {
          ...
          description: 'Payment of $15,750 received from Smith Family for Kitchen Renovation project',
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-800 dark:text-gray-300">Unread Notifications</p>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-800 dark:text-gray-300">Unread Messages</p>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-800 dark:text-gray-300">Urgent Items</p>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-800 dark:text-gray-300">Payment Updates</p>
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-4 font-medium text-sm border-b-2 transition-colors ${
                  activeTab === tab.id
                    ...
                    : 'border-transparent text-gray-800 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'
                }`}
              >
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between">
                          <div>
                            <h4 className={`font-medium ${conversation.unreadCount > 0 ? 'text-gray-900 dark:text-white' : 'text-gray-700 dark:text-gray-300'}`}>
                              {conversation.title}
                            </h4>
                            ...
                            {conversation.lastMessage && (
                              <p className="text-sm text-gray-800 dark:text-gray-300 mt-1 line-clamp-1">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center justify-between">
                <span className="text-gray-800 dark:text-gray-300">Today's Notifications</span>
              ...
              <div className="flex items-center justify-between">
                <span className="text-gray-800 dark:text-gray-300">Active Conversations</span>
                <span className="font-medium text-gray-900 dark:text-white">
              ...
              <div className="flex items-center justify-between">
                <span className="text-gray-800 dark:text-gray-300">Payment Updates</span>
              ...
              <div className="flex items-center justify-between">
                <span className="text-gray-800 dark:text-gray-300">Project Updates</span>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            ...
            <div className="space-y-2">
              ...
              <button className="w-full text-left px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                💰 Payment Related ({notifications.filter(n => n.type === 'payment' || n.type === 'invoice').length})
              </button>
              
              <button className="w-full text-left px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                👥 Client Communications ({notifications.filter(n => n.type === 'conversation' || n.type === 'client_action').length})
              </button>

    ...
    <div className="max-w-4xl mx-auto space-y-6 p-6">
      ...
      <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-600">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Required Columns</h4>
          ...
          <div>
            <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Optional Columns</h4>
            <ul className="text-sm text-gray-800 dark:text-gray-300 space-y-1">

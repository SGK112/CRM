      ...
      <div className={mobileClasses.card.body()}>
        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1 min-w-0">
            ...
            {client.company && (
              <p className={mobileOptimized(mobileClasses.text.small(), 'text-gray-600 dark:text-gray-400 truncate')}>
                {client.company}
              </p>
            )}
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center space-x-2 mt-1">
                ...
                {client.company && (
                  <span className={mobileOptimized(mobileClasses.text.small(), 'text-gray-500 dark:text-gray-400 truncate')}>
                    {client.company}
                  </span>
                )}
              </div>
        ...
        <div className={mobileOptimized(responsive.padding.md(), 'border-b border-gray-200 dark:border-gray-700')}>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div>
              ...
              <p className={mobileOptimized(mobileClasses.text.body(), 'text-gray-600 dark:text-gray-400 mt-1')}>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={mobileOptimized(
                  ...
                  'pl-10 w-full border border-gray-300 dark:border-gray-600 rounded-lg',
        ...
        <div className={responsive.padding.md()}>
          ...
          {filteredClients.length === 0 ? (
            ...
            <>
              {/* Results count */}
              <div className="mb-4">
                <p className={mobileOptimized(mobileClasses.text.small(), 'text-gray-600 dark:text-gray-400')}>

...
export default function DesignerPage() {
  ...
  const designTools: DesignTool[] = [
    ...
    { id: 'rectangle', name: 'Room', icon: RectangleStackIcon, category: 'shape', color: '#3B82F6' },
  ...
  const aiTools = [
    { id: 'ai-suggest', name: 'AI Suggestions', icon: SparklesIcon, category: 'ai', color: '#8B5CF6' },
    { id: 'ai-optimize', name: 'Optimize Layout', icon: LightBulbIcon, category: 'ai', color: '#F59E0B' },
    { id: 'ai-render', name: 'AI Render', icon: PhotoIcon, category: 'ai', color: '#EF4444' },
  ];

  const colorPalette = [
    '#3B82F6', '#8B5CF6', '#10B981', '#F59E0B', '#EF4444', 
    '#6B7280', '#1F2937', '#FFFFFF', '#FEE2E2', '#DBEAFE'
  ];
  ...
  const handleAiGenerate = async (type: string) => {
    ...
    if (type === 'ai-suggest') {
      ...
      const optimizedElements: DesignElement[] = [
        { id: 'island', type: 'rectangle', x: 300, y: 250, width: 120, height: 80, color: '#8B5CF6' },
        { id: 'counter1', type: 'rectangle', x: 150, y: 180, width: 200, height: 40, color: '#6B7280' },
        { id: 'counter2', type: 'rectangle', x: 450, y: 180, width: 150, height: 40, color: '#6B7280' },
      ];
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-2 space-y-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
              <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Basic Tools</h3>
          ...
          <div className="col-span-7">
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
              ...
              <div className="mt-4 text-sm text-gray-600 dark:text-gray-400">
                Selected tool: <span className="font-semibold">{selectedTool}</span> | 
          ...
          <div className="col-span-3 space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-1">
                    <input type="text" placeholder="12 ft" className="px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" />
                    <input type="text" placeholder="15 ft" className="px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" />
                  </div>
                </div>
              </div>
            </div>
            ...
            {hasCapability('ai.descriptions', userPlan) && (showAiPanel || aiSuggestions.length > 0) && (
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                ...
                <div className="space-y-2">
                  {aiSuggestions.map((suggestion, index) => (
                    <div key={index} className="p-3 bg-white/70 dark:bg-gray-800/70 rounded-lg text-sm text-gray-700 dark:text-gray-300">
                      {suggestion}
                    </div>
                  ))}
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-2 max-h-48 overflow-y-auto">
                {elements.length === 0 ? (
                  <p className="text-sm text-gray-500 dark:text-gray-400 italic">No elements added yet</p>
                ) : (
                  elements.map((element, index) => (
                    <div key={element.id} className="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      <div className="flex items-center space-x-2">
                        <div className="w-4 h-4 rounded" style={{ backgroundColor: element.color }}></div>
                        <span className="text-sm text-gray-700 dark:text-gray-300 capitalize">{element.type}</span>
                      </div>
                      <button 

...
import { StandardPageWrapper, StandardCard, StandardSection, StandardButton } from '../../../components/ui/StandardPageWrapper';
...
const availableNumbers = [
  { phoneNumber: '+1 (555) 111-2222', type: 'local', cost: 1.00 },
  { phoneNumber: '+1 (555) 333-4444', type: 'local', cost: 1.00 },
  { phoneNumber: '+1 (555) 555-6666', type: 'local', cost: 1.00 },
  { phoneNumber: '+1 (800) 777-8888', type: 'toll-free', cost: 2.00 },
  { phoneNumber: '+1 (800) 999-0000', type: 'toll-free', cost: 2.00 }
];
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="text-sm text-gray-500 capitalize">{number.type} Number</div>
                        </div>

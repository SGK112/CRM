            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-700 dark:to-blue-800 rounded-xl p-6 text-white shadow-xl">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-blue-100 dark:text-blue-200 text-lg">{project.description || 'No description provided'}</p>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm text-green-100 dark:text-green-200">Generate quick estimate</div>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm text-blue-100 dark:text-blue-200">Detailed estimate form</div>
                    </div>
                  </Link>
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm text-amber-100 dark:text-amber-200">Bill for this project</div>
                    </div>
                  </Link>
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm text-purple-100 dark:text-purple-200">Book appointment</div>
                    </div>
                  </Link>
                </div>
              </div>
                ...
                {estimates.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {estimates.slice(0, 5).map(estimate => (
                      <div key={estimate._id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                        <div className="flex items-center gap-3">
                          <div className="p-2 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                            <DocumentTextIcon className="h-4 w-4 text-gray-800 dark:text-gray-300"/>
                          </div>
                          <div>
                            <div className="font-medium text-gray-900 dark:text-white">#{estimate.number}</div>
                            <div className="text-sm text-gray-700 dark:text-gray-300">{estimate.status}</div>
                          </div>
                        </div>
                        <Link 

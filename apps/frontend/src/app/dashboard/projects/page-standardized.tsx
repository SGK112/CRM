...
import { StandardPageWrapper, StandardCard, StandardSection, StandardButton, StandardStat } from '../../../components/ui/StandardPageWrapper';
      ...
      >
        ...
        <StandardCard className="mb-6">
          <div className="flex flex-wrap gap-2 mb-4">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mr-4">Filter by Status:</h3>
            {[
              { key: 'all', label: 'All' },

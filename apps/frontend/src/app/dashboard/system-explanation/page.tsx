  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-blue-800 dark:text-blue-200 mb-4">
                You're using demo@test.com - perfect for exploring the CRM! All communication features 
                are simulated so you can test them safely without sending real emails or SMS.
              </p>
              <div className="bg-white dark:bg-blue-950 rounded-lg p-4 space-y-2">
                <h4 className="font-medium text-blue-900 dark:text-blue-100">What happens in demo mode:</h4>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-green-800 dark:text-green-200 mb-4">
                You're using a real account! Let's connect your tools to unlock powerful communication features.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            ...
            {systemStatus.demoMode ? (
              <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                <div className="text-xs font-medium text-blue-900 dark:text-blue-100">Demo Mode</div>
          ...
          <div className="space-y-3">
            ...
            {systemStatus.demoMode ? (
              ...
              <div className="mt-4 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                <div className="text-xs font-medium text-green-900 dark:text-green-100">Ready to Use</div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-3">
            ...
            {systemStatus.demoMode ? (
              <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                <div className="text-xs font-medium text-blue-900 dark:text-blue-100">Demo Mode</div>
                <div className="text-xs text-blue-800 dark:text-blue-200">Payments are simulated</div>
              </div>
            ) : (
      ...
      <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6">
        ...
        <div className="space-y-3">
          <div className="flex items-start space-x-3">
            <span className="flex-shrink-0 w-6 h-6 bg-yellow-500 text-white text-xs font-bold rounded-full flex items-center justify-center mt-0.5">1</span>
            <div>
              <h4 className="font-medium text-yellow-900 dark:text-yellow-100">Set up master API accounts</h4>
              <p className="text-sm text-yellow-800 dark:text-yellow-200">Get business accounts with Twilio, SendGrid, Stripe</p>
            </div>
          </div>
          
          <div className="flex items-start space-x-3">
            <span className="flex-shrink-0 w-6 h-6 bg-yellow-500 text-white text-xs font-bold rounded-full flex items-center justify-center mt-0.5">2</span>
            <div>
              <h4 className="font-medium text-yellow-900 dark:text-yellow-100">Implement OAuth flows</h4>
              <p className="text-sm text-yellow-800 dark:text-yellow-200">Gmail, Outlook, bank account connections</p>
            </div>
          </div>
          
          <div className="flex items-start space-x-3">
            <span className="flex-shrink-0 w-6 h-6 bg-yellow-500 text-white text-xs font-bold rounded-full flex items-center justify-center mt-0.5">3</span>
            <div>
              <h4 className="font-medium text-yellow-900 dark:text-yellow-100">Create billing system</h4>
              <p className="text-sm text-yellow-800 dark:text-yellow-200">Charge for SMS, storage, payment processing</p>
            </div>
          </div>
        </div>
      </div>

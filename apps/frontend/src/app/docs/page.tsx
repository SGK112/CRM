...
import { DocumentTextIcon, PlayIcon, BookOpenIcon, CodeBracketIcon } from '@heroicons/react/24/outline'
...
const docSections = [
  {
    ...
    items: [
      ...
      { title: 'Importing Data', href: '#import', description: 'Import existing clients and projects' },
      { title: 'User Permissions', href: '#permissions', description: 'Configure team access levels' },
  ...
  },
  {
    ...
    icon: BookOpenIcon,
    items: [
      { title: 'Project Management', href: '#projects', description: 'Create and manage construction projects' },
      { title: 'Client Relations', href: '#clients', description: 'Manage client communications' },
      { title: 'Document Management', href: '#documents', description: 'Store and organize project files' },
      { title: 'Scheduling & Calendar', href: '#scheduling', description: 'Manage crews and timelines' }
    ]
  },
  {
    ...
    items: [
      ...
      { title: 'Reporting & Analytics', href: '#analytics', description: 'Generate insights and reports' },
      { title: 'Third-party Integrations', href: '#integrations', description: 'Connect with other tools' },
  ...
  },
  {
    ...
    items: [
      { title: 'REST API Reference', href: '#api-reference', description: 'Complete API documentation' },
      ...
      <section className="px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto">
            Everything you need to know to get the most out of Remodely CRM for your construction business.
          </p>
        </div>
      </section>
                  ...
                  {section.items.map((item, itemIndex) => (
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <svg className="w-4 h-4 text-slate-400 group-hover:text-amber-400 transition-colors flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-6 sm:p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={index} className="flex items-center gap-3 p-3 rounded-lg bg-slate-800/40">

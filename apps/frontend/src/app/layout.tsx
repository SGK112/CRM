      ...
      <body className={inter.className + ' bg-slate-950 text-slate-100 antialiased'}>
        <Providers>
          <div className="flex min-h-screen flex-col">
            ...
            <footer className="mt-16 border-t border-slate-800 bg-slate-950/80 backdrop-blur supports-[backdrop-filter]:bg-slate-950/60">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 text-sm">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-slate-400">
                      <li><a className="hover:text-amber-400 transition-colors" href="/trial">Features</a></li>
                      <li><a className="hover:text-amber-400 transition-colors" href="/trial#pricing">Pricing</a></li>
                      <li><a className="hover:text-amber-400 transition-colors" href="/demo">Demo</a></li>
                      <li><a className="hover:text-amber-400 transition-colors" href="/roadmap">Roadmap</a></li>
                    </ul>
                  </div>
                  <div>
                    <h4 className="font-semibold text-slate-200 mb-3 text-xs uppercase tracking-wide">Resources</h4>
                    <ul className="space-y-2 text-slate-400">
                      <li><a className="hover:text-amber-400 transition-colors" href="/docs">Docs</a></li>
                      <li><a className="hover:text-amber-400 transition-colors" href="/blog">Blog</a></li>
                      <li><a className="hover:text-amber-400 transition-colors" href="/support">Support</a></li>
                      <li><a className="hover:text-amber-400 transition-colors" href="/status">Status</a></li>
                    </ul>
                  </div>
                  <div>
                    <h4 className="font-semibold text-slate-200 mb-3 text-xs uppercase tracking-wide">Company</h4>
                    <ul className="space-y-2 text-slate-400">
                      <li><a className="hover:text-amber-400 transition-colors" href="/about">About</a></li>
                      <li><a className="hover:text-amber-400 transition-colors" href="/careers">Careers</a></li>
                      <li><a className="hover:text-amber-400 transition-colors" href="/privacy">Privacy</a></li>
                      <li><a className="hover:text-amber-400 transition-colors" href="/terms">Terms</a></li>
                    </ul>
                  </div>
                </div>
                <div className="mt-10 pt-6 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-5 text-xs text-slate-500">
                    <a className="hover:text-amber-400 transition-colors" href="/security">Security</a>
                    <a className="hover:text-amber-400 transition-colors" href="/legal">Legal</a>

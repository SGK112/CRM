...
export const metadata: Metadata = {
  ...
  description: 'Legal information, terms of service, privacy policy, and compliance documentation for Remodely CRM.'
}
...
const complianceInfo = [
  {
    ...
    description: 'We comply with the European General Data Protection Regulation (GDPR) for all users.',
    details: [
  ...
  {
    title: 'SOC 2 Type II',
    description: 'Audited annually for security, availability, processing integrity, confidentiality, and privacy.',
    details: [
    ...
    <MarketingPage>
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm text-slate-400">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-indigo-400 rounded-full mt-2 flex-shrink-0" />
                    <span><strong className="text-slate-300">Access:</strong> Request a copy of all personal data we have about you</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-indigo-400 rounded-full mt-2 flex-shrink-0" />
                    <span><strong className="text-slate-300">Correct:</strong> Update or correct any inaccurate information</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-indigo-400 rounded-full mt-2 flex-shrink-0" />
                    <span><strong className="text-slate-300">Delete:</strong> Request deletion of your personal data</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-indigo-400 rounded-full mt-2 flex-shrink-0" />
                    <span><strong className="text-slate-300">Export:</strong> Download your data in a portable format</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-indigo-400 rounded-full mt-2 flex-shrink-0" />
                    <span><strong className="text-slate-300">Object:</strong> Object to certain types of data processing</span>
                  </li>
                </ul>
              </div>
                ...
                <div className="space-y-4">
                  <div className="rounded-lg border border-slate-700 p-4">
                    ...
                    <div className="text-sm text-slate-400">
                      Use the privacy controls in your account settings to manage your data directly.
                    </div>
                  </div>
                  <div className="rounded-lg border border-slate-700 p-4">
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-16">
        <div className="max-w-2xl mx-auto">
          <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-6 sm:p-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-6 text-center">Company Information</h2>
            ...
            <div className="space-y-4 text-sm text-slate-400">
              ...
              <div>
                <strong className="text-slate-300">Registered Agent:</strong> Corporation Service Company
              </div>
              <div>
                <strong className="text-slate-300">Incorporation:</strong> Delaware, USA
              </div>
              <div>
                <strong className="text-slate-300">EU Representative:</strong> Available upon request for GDPR matters
              </div>
            </div>
            ...
            <div className="border-t border-slate-700 pt-6 mt-6 text-center">
              <p className="text-xs text-slate-500 leading-relaxed">
                ...
                from time to time. Material changes will be communicated to users via email or in-app notification.
              </p>
            </div>
          </div>
        </div>

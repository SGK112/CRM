...
export default function OnboardingPage() {
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-[var(--text-dim)]">Manage projects, clients, and team members</p>
            </div>
            <span className="text-sm text-[var(--text-dim)]">Up to {profile.teamSize === 'Just me' ? '0' : '5'}</span>
          </div>
          <div className="flex justify-between items-center">
            <div>
  ...
  const renderProjectStep = () => (
    <div className="space-y-6">
      ...
      <div className="bg-[var(--surface-2)] rounded-lg p-6">
        <h3 className="text-lg font-semibold text-[var(--text)] mb-4">What you can do with projects:</h3>
  ...
  const getCurrentStepContent = () => {
    switch (currentStep) {
      ...
      case 3: return renderProjectStep();
      default: return null;
    }
  };

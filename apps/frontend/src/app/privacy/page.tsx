...
export default function PrivacyPage() {
  return (
    <MarketingPage>
      <MarketingHero title="Privacy Policy" subtitle="How we collect, use, protect & retain your data." />
      <div className="max-w-3xl mx-auto px-6 pb-24 text-sm leading-relaxed space-y-6 text-slate-300">
        ...
        <p>We believe contractors should always know what happens to their data. This summary version keeps it simple. A full legal version will replace this placeholder.</p>
        <div className="grid sm:grid-cols-2 gap-6 text-slate-200">
          {[
            ['Data Ownership','You own your project, client, financial & media data. We are a processor.'],
            ['Retention','Delete a workspace to purge associated data within 30 days (backups 60).'],
        ...
        <p className="text-slate-400">Need a DPA or formal PDF copy? Email <a href="mailto:privacy@remodely.com" className="text-amber-400 hover:text-amber-300">privacy@remodely.com</a>.</p>
      </div>
    </MarketingPage>
  )
}

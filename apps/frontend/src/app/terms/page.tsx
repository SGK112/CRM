...
export default function TermsPage() {
  ...
  const handleLegalInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
        ...
        <div className="mt-12 pt-8 border-t border-slate-800">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="rounded-lg border border-slate-800 bg-slate-900/40 p-6">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  <EnvelopeIcon className="w-4 h-4 text-slate-400" />
                  <a href="mailto:enterprise@remodely.com" className="text-blue-400 hover:text-blue-300">
            ...
            <div className="mt-8 rounded-xl border border-slate-800 bg-slate-900/40 p-6">
              ...
              {submitSuccess && (
                <div className="bg-green-500/10 border border-green-500/30 text-green-400 px-4 py-3 rounded-md text-sm mb-6">
                  Your legal inquiry has been submitted successfully. Our legal team will review and respond within 2-3 business days.
                </div>
              )}
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-4">
            <div className="text-center p-4 rounded-lg border border-slate-800 bg-slate-900/40">
              ...
              <p className="text-sm text-slate-400 mb-3">How we collect, use, and protect your data</p>
              <a href="/privacy" className="text-amber-400 hover:text-amber-300 text-sm font-medium">
                View Policy →
              </a>
            </div>
            <div className="text-center p-4 rounded-lg border border-slate-800 bg-slate-900/40">
              <h4 className="font-semibold text-slate-100 mb-2">Security</h4>
              <p className="text-sm text-slate-400 mb-3">Our security practices and certifications</p>
              <a href="/security" className="text-amber-400 hover:text-amber-300 text-sm font-medium">
                Learn More →
              </a>
            </div>
            <div className="text-center p-4 rounded-lg border border-slate-800 bg-slate-900/40">
              ...
              <a href="/compliance" className="text-amber-400 hover:text-amber-300 text-sm font-medium">
                View Details →
              </a>
            </div>
          </div>

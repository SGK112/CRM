    ...
    <div className="bg-slate-900/60 py-16 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-400">See how we compare to spreadsheets and other solutions</p>
        </div>
            ...
            <table className="min-w-full">
              <thead className="bg-slate-900/70">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-amber-500 uppercase tracking-wider">Remodely CRM</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-slate-400 uppercase tracking-wider">
                    Spreadsheets
                  </th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-slate-400 uppercase tracking-wider">

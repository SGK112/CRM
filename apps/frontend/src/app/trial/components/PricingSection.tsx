    ...
    <div className="bg-slate-900/60 py-16 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 mb-6">
                  {plan.features.map((feature, index) => (
                    <li key={index} className="flex items-center bg-slate-900/60 border border-slate-800 rounded-md px-3 py-2 text-sm text-slate-300">
        ...
        <div className="text-center mt-8">
          <p className="text-slate-400 mb-4">All plans include a 14-day free trial. No credit card required to start.</p>
          <Link
            href="/auth/register"

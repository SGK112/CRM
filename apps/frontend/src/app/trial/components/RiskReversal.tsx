...
import { ShieldCheckIcon, ClockIcon, PhoneIcon, CurrencyDollarIcon } from '@heroicons/react/24/outline'
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="flex flex-col items-center">
            ...
            <p className="text-slate-400 text-center">Start your trial instantly without any payment information</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-slate-400 text-center">Full access to all features with no limitations or restrictions</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-slate-400 text-center">Our team will help you get started and import your data</p>
          </div>
        </div>
        ...
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-6 mb-8">
          ...
          <p className="text-amber-300 text-center">
            Sign up this month and get your first 3 months for just $39/month (reg. $59).<br />
        ...
        <div className="text-slate-400 mb-8">
          ...
          <p>
            After 14 days, you can choose a plan that fits your business. If you don't upgrade, your account is simply paused - no charges, no cancellation fees, no hassle.
          </p>
        </div>
      </div>
    </div>

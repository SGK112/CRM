      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-slate-900/70 border border-slate-800 rounded-xl shadow-sm p-6 hover:border-amber-500/40 hover:shadow-lg hover:shadow-amber-600/10 transition group">
              <div className="flex items-center mb-4">
                ...
                />
                <div>
                  <h4 className="font-semibold text-slate-100 group-hover:text-amber-400 transition-colors">{testimonial.name}</h4>
              ...
              <div className="flex items-center justify-between text-sm text-slate-500 border-t border-slate-800 pt-4">
                ...
                <div className="text-right">
                  <div className="font-medium text-slate-200">{testimonial.projectsManaged} Projects</div>

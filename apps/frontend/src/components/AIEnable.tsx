  ...
  return (
    <>
      <div className={`flex items-center ${className}`}>
        ...
        >
          <Sparkles
            className={`h-4 w-4 ${isAIEnabled ? 'text-white' : 'text-gray-500 dark:text-gray-400'}`}
          />
          ...
          {!hasProPlan && !isAIEnabled && <Crown className="h-3 w-3 text-amber-500" />}
        </button>
      </div>
            ...
            <div className="relative transform overflow-hidden rounded-xl bg-white dark:bg-gray-800 px-6 py-8 shadow-2xl transition-all sm:w-full sm:max-w-lg">
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Upgrade to Pro to access AI-enhanced descriptions, smart pricing suggestions, and

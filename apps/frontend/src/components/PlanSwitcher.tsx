...
export default function PlanSwitcher({ currentPlan, onPlanChange }: PlanSwitcherProps) {
  ...
  const getPlanColor = (plan: PlanTier) => {
    switch (plan) {
      case 'basic': return 'border-gray-300 bg-gray-50 text-gray-800';
      case 'ai-pro': return 'border-blue-300 bg-blue-50 text-blue-800';
      case 'enterprise': return 'border-purple-300 bg-purple-50 text-purple-800';
  ...
  return (
    <div className="space-y-6">
          ...
          return (
            ...
            >
              ...
              <div className="text-center mb-6">
                <div className={`w-12 h-12 rounded-full mx-auto mb-3 flex items-center justify-center ${getPlanColor(plan.id)}`}>
      ...
      <div className="text-center text-sm text-gray-600 dark:text-gray-400">
        ...
        <p className="mt-1">Need enterprise features? <a href="mailto:sales@company.com" className="text-blue-600 hover:text-blue-700">Contact sales</a></p>
      </div>
    </div>
  );
}

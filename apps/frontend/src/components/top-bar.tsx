  ...
  return (
    <div className="sticky top-0 z-40 w-full border-b border-token surface-1/80 backdrop-blur supports-[backdrop-filter]:surface-1/60">
      <div className="mx-auto flex h-12 items-center gap-4 px-4">
        ...
        >
          <span className="h-7 w-7 rounded-md bg-amber-600 flex items-center justify-center text-[10px] font-bold text-white shadow-inner ring-1 ring-amber-400/40">
            RA
          </span>
        ...
        <nav className="flex items-center gap-4 text-xs text-secondary">
          ...
          <Link href="/dashboard/clients" className="hover:text-amber-500 transition-colors">
            Clients
          </Link>

...
export const mobile = {
  ...
  touchTarget: (...classes: string[]) => mobileOptimized(
  ...
  willChange: (...classes: string[]) => mobileOptimized(
    'will-change-transform',
    ...classes
  ),
  
  // Safe areas for notched devices
  safeTop: (...classes: string[]) => mobileOptimized(
    'pt-safe-top',
    'supports-[padding-top:env(safe-area-inset-top)]:pt-[env(safe-area-inset-top)]',
    ...classes
  ),
  
  safeBottom: (...classes: string[]) => mobileOptimized(
    'pb-safe-bottom',
  ...
  card: (...classes: string[]) => mobileOptimized(
  ...
  button: (...classes: string[]) => mobileOptimized(
  ...
  text: {
    title: (...classes: string[]) => mobileOptimized(
      'text-xl sm:text-2xl font-bold tracking-tight',
      ...classes
    ),
    subtitle: (...classes: string[]) => mobileOptimized(
      'text-sm sm:text-base text-gray-600 dark:text-gray-400',
      ...classes
    ),
    body: (...classes: string[]) => mobileOptimized(
  ...
  // App-like navigation
  navigation: (...classes: string[]) => mobileOptimized(
  ...
  bottomSheet: (...classes: string[]) => mobileOptimized(
  ...
  spacing: {
    page: (...classes: string[]) => mobileOptimized(
    ...
    tight: (...classes: string[]) => mobileOptimized(
      'p-3 sm:p-4',
      ...classes
    )
  }

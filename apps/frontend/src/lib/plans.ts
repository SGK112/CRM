...
export const PLANS: Record<PlanTier, Plan> = {
  basic: {
    ...
    features: [
      { id: 'clients', name: 'Client Management', description: 'Up to 50 clients', included: true, limit: 50 },
      { id: 'projects', name: 'Project Tracking', description: 'Up to 25 projects', included: true, limit: 25 },
      { id: 'calendar', name: 'Basic Calendar', description: 'Appointment scheduling', included: true },
      { id: 'estimates', name: 'Basic Estimates', description: 'Create and send estimates', included: true },
      { id: 'invoices', name: 'Basic Invoicing', description: 'Create and send invoices', included: true },
      { id: 'documents', name: 'Document Storage', description: '1GB storage', included: true, limit: 1 },
      { id: 'support', name: 'Community Support', description: 'Community forums', included: true },
      { id: 'ai', name: 'AI Features', description: 'Smart automation and insights', included: false, upgrade: true },
      { id: 'voice', name: 'Voice Agents', description: 'AI-powered voice assistants', included: false, upgrade: true },
      { id: 'design', name: 'Design Studio', description: 'Professional design tools', included: false, upgrade: true },
    ]
  },
  ...
  'ai-pro': {
    ...
    features: [
      { id: 'clients', name: 'Client Management', description: 'Up to 500 clients', included: true, limit: 500 },
      { id: 'projects', name: 'Project Tracking', description: 'Up to 200 projects', included: true, limit: 200 },
      { id: 'calendar', name: 'Smart Calendar', description: 'AI-powered scheduling', included: true },
      { id: 'estimates', name: 'AI Estimates', description: 'Smart pricing suggestions', included: true },
      { id: 'invoices', name: 'Smart Invoicing', description: 'Automated invoice generation', included: true },
      { id: 'documents', name: 'Document Storage', description: '25GB storage', included: true, limit: 25 },
      { id: 'ai', name: 'Full AI Suite', description: '5,000 AI requests/month', included: true, limit: 5000 },
      { id: 'voice', name: 'Voice Agents', description: '500 minutes/month', included: true, limit: 500 },
      { id: 'design', name: 'Design Studio', description: 'Professional design tools', included: true },
      { id: 'analytics', name: 'Advanced Analytics', description: 'AI-powered insights', included: true },
      { id: 'integrations', name: 'API Access', description: 'Zapier & custom integrations', included: true },
      { id: 'support', name: 'Priority Support', description: 'Email & chat support', included: true },
    ]
  },
  ...
  enterprise: {
    ...
    features: [
      { id: 'unlimited', name: 'Unlimited Everything', description: 'No limits on clients or projects', included: true },
      { id: 'ai', name: 'Unlimited AI', description: 'Unlimited AI requests', included: true },
      { id: 'voice', name: 'Enterprise Voice', description: '2,000 minutes/month', included: true, limit: 2000 },
      { id: 'design', name: 'Complete Design Suite', description: 'Including CAD integration', included: true },
      { id: 'storage', name: 'Enterprise Storage', description: '500GB storage', included: true, limit: 500 },
      { id: 'branding', name: 'Custom Branding', description: 'White-label options', included: true },
      { id: 'support', name: 'Dedicated Support', description: 'Phone, email, and dedicated rep', included: true },
...
export function getPlanColor(plan: PlanTier): string {
  switch (plan) {
    ...
    case 'ai-pro': return 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400';

...
export const simple = {
  ...
  // Card components
  card: (className = '') =>
    `bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 ${className}`,
  ...
  text: {
    ...
    subtitle: (className = '') =>
      `text-lg font-semibold text-gray-900 dark:text-white ${className}`,
  ...
  // Form inputs
  input: (className = '') =>
    `w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${className}`,

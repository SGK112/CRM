...
export const standardComponents = {
  ...
  button: {
    ...
    primary: 'bg-gradient-to-r from-orange-500 to-red-500 text-white hover:from-orange-600 hover:to-red-600 hover:scale-105 shadow-lg hover:shadow-xl',
    secondary: 'bg-[var(--surface-1)] border border-[var(--border)] text-[var(--text)] hover:bg-[var(--surface-2)] hover:scale-105',
    sizes: {
  ...
  input: {
    ...
    focus: 'focus:outline-none focus:border-[var(--input-border-focus)] focus:ring-2 focus:ring-orange-500/20',
  ...
  header: {
    ...
    wrapper: 'mb-6 bg-gradient-to-r from-white via-gray-50 to-white dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-600 shadow-lg'
  },
  ...
  table: {
    wrapper: 'bg-[var(--surface-1)] rounded-lg border border-[var(--border)] overflow-hidden shadow-lg',
    header: 'bg-gray-50 dark:bg-[var(--surface-2)] text-xs uppercase tracking-wide text-[var(--text-muted)]',
...
export const createStatBlockClasses = (color: 'default' | 'green' | 'blue' | 'purple' | 'orange' = 'default') => {
  const colorMap = {
...
export const createPageHeaderClasses = () => {
  return cn(
    standardComponents.header.wrapper
  );
};
